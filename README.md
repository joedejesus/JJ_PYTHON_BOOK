...
GitHub los muestra separados, pero **al descargar el repositorio se obtiene una sola carpeta con todo el libro completo**, tal como fue diseñado para VS Code.
...
Este libro está creado específicamente para VS Code porque:

- permite ejecutar código al instante  
- facilita la edición y experimentación  
...
Este libro está diseñado para ser usado **localmente**, dentro de VS Code.
...
Abre la carpeta completa: Archivo → Abrir carpeta → JJ_PYTHON_BOOK
...
Este proyecto nació con la intención de acompañarte mientras construyes tu propio camino en Python, paso a paso, con calma y con curiosidad.  
